    ...
    pub fn show(ui: &mut egui::Ui, config: &mut VMConfig, colors: &ThemeColors) {
        ...
        ui.with_layout(Layout::left_to_right(Align::TOP).with_main_wrap(true), |ui| {
            ...
            ui.allocate_ui_with_layout(
                ...
                |ui| {
                    card_group(ui, "安全设置", Some("🛡"), colors, |ui| {
                        ...
                        if let Some(ref mut security) = config.security_label {
                            grid(ui, "security_grid", 2, |ui| {
                                ...
                                ui.label("重标记:");
                                let relabel =
                                    security.relabel.get_or_insert_with(|| "".to_string());
                            ...
                            ui.horizontal(|ui| {
                                ui.label("基础标签:");
                                let baselabel =
                                    security.baselabel.get_or_insert_with(|| "".to_string());
                            ...
                            ui.horizontal(|ui| {
                                ui.label("镜像标签:");
                                let imagelabel =
                                    security.imagelabel.get_or_insert_with(|| "".to_string());
